"""
UNISC Moodle Downloader
=======================
Faz login no Portal Virtual UNISC e baixa arquivos de blocos (seções) de cursos.
Compatível com qualquer distro Linux (Fedora, Ubuntu, Arch…), Windows e macOS.

── Dependências Python ──────────────────────────────────────────────────────
    pip install selenium beautifulsoup4 requests

── Driver do browser (escolha UM) ──────────────────────────────────────────
  Firefox (recomendado no Fedora):
  ...
  OU deixe o script instalar o driver automaticamente via webdriver-manager:
    pip install webdriver-manager
    (neste caso não precisa instalar geckodriver/chromedriver manualmente)

── Uso ──────────────────────────────────────────────────────────────────────
    python unisc_moodle_downloader.py
"""
...
# ═══════════════════════════════════════════════════════════════════════════
# Criação do WebDriver (Firefox ou Chromium, com fallback automático)
# ═══════════════════════════════════════════════════════════════════════════
